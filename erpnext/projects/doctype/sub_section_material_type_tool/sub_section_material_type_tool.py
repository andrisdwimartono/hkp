...
class SubSectionMaterialTypeTool(Document):
	def on_trash(self):
	...
	def validate(self):
		...
		for d in self.tools:
			...
			if xx:
				...
				a_doc.item 						= d.alat_bantu_kerja
				a_doc.item_name 				= d.alat_bantu_kerja
				a_doc.uom 						= d.uom
				...
				a_doc = frappe.get_doc({
					...
					"item"						: d.alat_bantu_kerja,
					"item_name"					: d.alat_bantu_kerja,
					"uom"						: d.uom,
					"location"					: d.location,
					"year"						: d.year,
					"price"						: d.price,

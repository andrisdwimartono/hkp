	...
	def autoname(self):
		...
		if a:
			...
			if urut < 9:
				...
				urut2 = "{0}".format(urut)
			self.name = "{2}/{3}/KPA/{0}/{1}".format(bulan, mydate.year-2000, urut2, get_department_abbr_by_session())
		else:
			self.name = "001/{2}/KPA/{0}/{1}".format(bulan, mydate.year-2000, get_department_abbr_by_session())

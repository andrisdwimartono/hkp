...
frappe.ui.form.on('Realisasi Slip Pembayaran Subkon', {
	setup: function(frm) {
		frm.set_query("slip_pembayaran_subkon", function() {
			return {
				filters: {
					'docstatus': 1
				}
	...
	slip_pembayaran_subkon: function(frm){
		...
		frappe.call({
			method: 'erpnext.pengendalian_biaya.doctype.slip_pembayaran_subkon.slip_pembayaran_subkon.get_detail',
			args: {

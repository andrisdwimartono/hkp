...
frappe.ui.form.on("Form Payment Entry Detail", "budget", function(frm, cdt, cdn) {
    var total_budget = 0;
...
frappe.ui.form.on("Form Payment Entry Detail", "approved_budget", function(frm, cdt, cdn) {
    var total_budget = 0;
	var total_approved_budget = 0;
	for(var i = 0; i < frm.doc.details.length; i++){
		var budget=frm.doc.details[i].budget?frm.doc.details[i].budget:0;
